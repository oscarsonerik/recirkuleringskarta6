...
roofarea = 100                                     # m2
tanksize = 50                                     # m3 
wateruseday = 200 * 0.001                         # Gör om l/day tll m3/day. (l = dm3 --> 1m3 = 1000dm3)
day = df['Dagar']                                 # Dag
...
def model_streamlit(tanksize, tankVol, tot_h2o_use, water_out, wateruseday, day, month, prec_m3, temp):
  ...
  for i in day:
    ...
    if month[i-1] == current_month:
      ...
      current_month += 1 
    counter += 1
  return tot_h2o_use, water_out, tankVol, tak_lager, counter, monthly_collected_water, monthly_lost_water, cum_water_use, vattentanknivå, drink_water_use
...
print(f'Vattenmängd som kommer ut i systemet {round(total,1)}')
print('')
#print(svar[5])
#print(sum(svar[5]))
#print(svar[6])
